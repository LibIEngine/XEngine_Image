#pragma once
/********************************************************************
//    Created:     2022/04/26  10:56:21
//    File Name:   D:\IEngine_Image\IEngine_Source\IEngine_ImageInformation\ImageInfo_Define.h
...
备注：
*********************************************************************/
extern "C" BOOL ImageInfo_Set_FileResolution(LPCTSTR lpszSrcFile, int nWidth, int nHeight, LPCTSTR lpszDstFile = NULL);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" BOOL ImageInfo_Set_FileFlip(LPCTSTR lpszSrcFile, int nOPMethod, LPCTSTR lpszDstFile = NULL);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" BOOL ImageInfo_Set_FileColorCvt(LPCTSTR lpszSrcFile, ENUM_XENGINE_IMAGE_COLOR_INFO enColorInfo, LPCTSTR lpszDstFile = NULL);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" BOOL ImageInfo_Set_FileLigth(LPCTSTR lpszSrcFile, int nGamma, LPCTSTR lpszDstFile = NULL);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" BOOL ImageInfo_Set_FileChannle(LPCTSTR lpszSrcFile, TCHAR*** ppptszDstFile, int nListCount, BOOL bCombo = FALSE);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" BOOL ImageInfo_Get_Attr(LPCTSTR lpszFile, IMAGEINFO_BASEATTR* pSt_BaseInfo = NULL, IMAGEINFO_EXTENDATTR* pSt_ExtAttr = NULL);